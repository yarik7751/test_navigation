package by.yarik.test_navigation.fragments.main.currencies.adapter
...
class CurrenciesAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when(viewType) {
            TITLE -> {
                CurrenciesViewHolder(initViewForHolder(parent, R.layout.item_currency_title))
            }

            INFO -> {
                CurrenciesViewHolder(initViewForHolder(parent, R.layout.item_currency))
            }
